    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "relative z-[70] max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-hidden rounded-xl border border-white/10 bg-[#17171a] text-[#f4f4f5] shadow-2xl shadow-black/60",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "focus:bg-white/[0.06] focus:text-[#f4f4f5] data-[state=checked]:text-[#ff6a1a]",
    ...
    >
      ...
      <span className="absolute right-2.5 flex size-4 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="size-4 text-[#ff6a1a]" />
        </SelectPrimitive.ItemIndicator>
      </span>
    </SelectPrimitive.Item>
  );
